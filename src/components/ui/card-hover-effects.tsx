...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full p-4 overflow-hidden bg-secondary border border-secondary/20 group-hover:border-primary relative z-20 transition-all duration-200",
        className
      )}
    >
